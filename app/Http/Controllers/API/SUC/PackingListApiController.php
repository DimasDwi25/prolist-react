...
class PackingListApiController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->merge([
            'pn_id' => $request->pn_id, // Keep as string for project_number validation
        ...
        $packingList->load(['project.client', 'project.quotation.client', 'plType', 'expedition', 'intPic', 'creator', 'destination']);
    ...
    public function update(Request $request, $id)
    {
        ...
        $validated['pn_id'] = isset($validated['pn_id']) ? $validated['pn_id'] : null; // Keep as string
